        ...
        <div class="box box-info">
            ...
            {{csrf_field()}}
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label" name="date" placeholder="date and time">Date</label>
                  ...
                  <div class="col-sm-10">
                    <div class="col-md-12" id="parent">
                      <div id="child" class="child">
                        <div class="col-md-6">
                          <input type="text" name="ticket_name[]" class="form-control" placeholder="Name" required/>
                        </div>
                        <div class="col-md-6">
