                ...
                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="url" value="{{$id->url}}" class="form-control" id="inputEmail3"
                                       placeholder="url to be redirected to on click" required>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="alt" class="form-control" value="{{$id->alt}}"
                                       id="inputPassword3" placeholder="Alt caption for advert" required>
                            </div>
                        </div>
