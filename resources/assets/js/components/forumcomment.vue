    ...
    <div class="comments">
        ...
        <form action="" @submit.prevent="edit ? editComment(comment.id) : createComment()" v-if="loggedin">
            <div class="form-group col-md-12">
                <div class="form-group col-md-12"> <textarea name="comment" id="textarea" placeholder="&nbsp Write your responses" rows="3" class="form-control" style="
           padding: 1em;
            border: none;
            width: 100%;
            border-radius: 10px;
        ...
        <div id="openModal" class="modalDialog">
            <div>
                ...
                <div>
                    ...
                    <textarea name="comment" id="textarea" ref="textarea" placeholder=" Write your response" rows="3" class="form-control" style="
           padding: 1em;
            border: none;
            width: 100%;
            margin-top: 1.2em;
