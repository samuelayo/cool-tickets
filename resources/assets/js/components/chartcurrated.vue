<template>
    <div id="chartcurrated">
        ...
        <div class="col-md-12">
            <h1 style="text-align: center; font-weight: 700;line-height: 1.3;">CHARTS <br>
                   ...
                   <span class="badge badge-pink" style="background-color: #009efd;">&nbsp;</span>
                    <span>Last week</span>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row"><br>
                                <div class="col-md-2"
                                     v-for="(chart, index) in all_chart[currentchart][currentchartweek]"><p
                                        class="chart-num"><strong> {{chart.position}} </strong></p>
