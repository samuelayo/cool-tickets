    ...
    <div id="landing">
                ...
                <div class="carousel-cell" v-for="show in shows">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div data-type="youtube" :data-video-id="gup('v', show.link)"
                                 style="min-width: 200px !important"></div>
                            <iframe width="100%" height="100%"
                                    :src="'https://www.youtube.com/embed/'+gup('v', show.link)" frameborder="0"
        ...
        <div class="container-fluid" v-if="rearrange_podcasts[currentweek]">
            <div class="row">
               ...
               <small>
               <a href="javascript:void(0)" @click="pweekpod"> <span class="ion-ios-arrow-left"></span> </a><span
                       style="    text-transform: uppercase;
                  letter-spacing: 1px;"> Week {{currentweek}} </span> <a href="javascript:void(0)"
                                                                         @click="nweekpod"> <span
                ...
                <div class="col-md-12" v-if="rearrange_podcasts[currentweek]">
                    <div class="col-md-6">
                        <div class="row">
                            <br>
                            <div class="col-sm-3" v-for="(pod, index) in rearrange_podcasts[currentweek]"
                                 v-if="index <= 3">
                                ...
                                <a href="javascript:void(0)" class="ratio img-responsive"
                                   :style="'background-image: url('+pod.image+'); box-shadow: rgba(0, 0, 0, 0.2) 0px 0px 0px 1000px inset;'"></a>
                                <span class="badge badge-play" style="background: blue;"><small><a
                                        href="javascript:void(0)"
                                        @click="playthis(pod.id, 'podcast', pod.path, pod.title)"><span
                                        class="ion-ios-play"></span></a></small></span> <span> <p style="
    font-size: 1.1em;
    background: #ececec;
...
"><small><a href="" style="color: rgb(0, 0, 0);">
       ...
       -->
            <div v-if="rearrange_podcasts[currentweek]"
  ...
  <span style="font-size: 23px; background-color: #F3F5F6; padding: 0 10px;">
    Show more <!--Padding is optional-->
        ...
        <div class="col-md-12">
            <a v-if="homepage_chart[1]" :href="homepage_chart[1].url">
                <adimage :src="'/'+homepage_chart[1].image_url" width="100%" height="100%"
        ...
        <div class="container-fluid" v-if="all_chart[currentchart][currentchartweek]">
            <div class="row">
               ...
               <small>
               <a href="javascript:void(0)" @click="pweekcht()"> <span class="ion-ios-arrow-left"></span> </a><span
                       style="    text-transform: uppercase;
                  letter-spacing: 1px;"> Week {{currentchartweek}} </span> <a href="javascript:void(0)"
                                                                              @click="nweekcht()"> <span
                       class="ion-ios-arrow-right"></span> </a>
               </small>
               </span>
               ...
               <span>Last week</span>
                ...
                <div class="col-md-12 chartsall">
                    <div class="col-md-6">
                        <div class="row">
                            <br><br>
                            <div class="col-sm-3" v-for="(chart, index) in all_chart[currentchart][currentchartweek]"
                                 v-if="index <= 3" :id="'sa_'+index">
                                <p class="chart-num"><strong> {{chart.position}} </strong></p>
                                <a class="ratio img-responsive img-circle"
                                   :style="'background-image: url('+chart.songs.image+');'"></a>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <br><br>
                            <div class="col-sm-3" v-for="(chart, index) in all_chart[currentchart][currentchartweek]"
                                 v-if="(index > 3 && index <=6)" :id="'sa2_'+index">
                                <p class="chart-num"><strong> {{chart.position}} </strong></p>
                                <a class="ratio img-responsive img-circle"
                                   :style="'background-image: url('+chart.songs.image+');'"></a>
                                <span class="badge badge-notify"><small>{{noofchart(chart.song)}}</small></span>
                        ...
                        <center><small><a href="#">{{chart.songs.artistname}}</a></small></center>
                            ...
                            <div class="col-sm-3">
                                <router-link
                                        v-bind:to="{ name: 'chartcurrated', params: {currentchartweek: currentchartweek }}">
                                    <a id="see-all" href="#" class="ratio img-responsive img-circle">See Complete
                                        List</a>
                                </router-link>
                            </div>
                        </div>
            ...
            <div class="col-md-12">
                    ...
                    <div class="panel panel-default shadowed">
                        <div>
                            <a v-if="sidebar_chart_2[0]" :href="sidebar_chart_2[0].url">
                                <adimage :src="'/'+sidebar_chart_2[0].image_url" width="100%" height="100%" isd="0"
                                         style="padding: 1em;"></adimage>
                            </a>
                            <br>
                            <br>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 tr_content" v-for="trend in trending">
                                    ...
                                    <div class="col-md-8">
                                        <h4 class="category-tag" style="margin-top: 1em;"><span id="tag-cat"><router-link
                                                :to="{ name: 'blogcategory', params: { id: trend.category.id, name:trend.category.name }}">{{trend.category.name}}</router-link></span>
                                        </h4>
                                        <router-link
                ...
                <div class="col-md-6">
                    ...
                    <div class="panel panel-default shadowed" v-for="newpost in newones">
                        <div class="rising"
                             :style="'background-image: url('+newpost.image+'); box-shadow: inset 0 0 0 1000px rgba(0,0,0,.3);'">
                            <router-link
                                    v-bind:to="{ name: 'blogpost', params: { id: newpost.id, title: respace(newpost.title) }}">
                                <h4 class="rising_head" style="color: white;">
                                    <router-link
                                            :to="{ name: 'blogcategory', params: { id: newpost.category.id, name:newpost.category.name }}">
                                        {{newpost.category.name}}
                                    </router-link>
                                </h4>
                                <h3 class="rising_topic" style="color: white;">{{newpost.title}}</h3>
                            </router-link>
                            <span class="rising_share" style="color: white;"><i aria-hidden="true"
                                                                                class="ion-android-open"
                                                                                style="font-size:1.57em;vertical-align:middle;"></i> <a
                                    href="#" style="color: white;">{{newpost.view_count | money }} shares</a></span>
                        </div>
                    </div>
                </div>
                <!-- end rising -->
    ...
    border-bottom: 1px solid #ddd;
          "><i class="ion-social-facebook"
               style="color:#fff; padding-left:.75em; padding-right:.7em; padding-top:.1em; padding-bottom:.1em; margin-right:.5em; background:blue; border-radius:50%;"> </i>
                                Like us on Facebook</p>
                            <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fcoolfmnigeria%2F&tabs=timeline&width=340&height=500&small_header=true&adapt_container_width=true&hide_cover=false&show_facepile=true&appId"
                                    width="100%" height="450px" style="border:none;overflow:hidden;padding: 1em;"
    ...
    padding-top: 1em;
    "><i class="ion-android-hand"
         style="color:#fff; padding-left:.6em; padding-right:.5em; padding-top:.1em; padding-bottom:.27em; margin-right:.3em; background:red; border-radius:50%;"> </i>
                                Join our fan community</p>

                            <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2FCoolFMFanPage%2F&tabs=timeline&width=340&height=500&small_header=true&adapt_container_width=true&hide_cover=false&show_facepile=true&appId"
                                    width="100%" height="450px" style="border:none;overflow:hidden;padding: 1em;"
                                    scrolling="no" frameborder="0" allowTransparency="true"></iframe>
    ...
    "><i class="ion-social-twitter"
         style="color:rgb(52, 155, 219); padding-left:.6em; padding-right:.34em; padding-top:.19em; padding-bottom:.29em; margin-right:.3em; background:#fff; vertical-align:top; border-radius:50%; font-size:.9em;"> </i>
                                JOIN THE CONVERSATION</p>

                            <a class="twitter-timeline" href="https://twitter.com/CoolFMNigeria" data-height="300"
                               data-width="100%" style="padding: 1em;">Tweets by CoolFMNigeria</a>
                            <br>
                            <p style="
    font-size: 1.2em;
    text-transform: uppercase;
    ...
    "><i class="ion-social-youtube"
         style="color:red; padding-left:.6em; padding-right:.34em; padding-top:.19em; padding-bottom:.29em; margin-right:.3em;  vertical-align:top; border-radius:50%;"> </i>
                                TOP VIDEO</p>
                            <iframe src="https://www.youtube.com/embed/?listType=user_uploads&list=CoolFM969"
                                    width="100%" height="100%"
                                    style="border:none;overflow:hidden;padding: 1em;"></iframe>
                            <a v-if="sidebar_chart[0]" :href="sidebar_chart[0].url">
                                <adimage :src="'/'+sidebar_chart[0].image_url" width="100%" height="100%" isd="1"
                                         style="padding: 1em;"></adimage>
                            </a>
                            <br>
                            <br>
                            <a v-if="sidebar_chart_2[1]" :href="sidebar_chart_2[1].url">
                                <adimage :src="'/'+sidebar_chart_2[1].image_url" width="100%" height="100%" isd="2"
                                         style="padding: 1em;"></adimage>
                            </a>
                            <br>
                            <br>
...
<script>
    ...
    export default {
        ...
        mounted: function () {
            ...
            loadScript("//platform.twitter.com/widgets.js").then(function () {
