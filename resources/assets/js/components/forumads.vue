        ...
        <div class="panel panel-default shadowed">
            <div class="row"><br>
                <div class="col-md-12 ht_content" v-for="(ho, index) in hot" v-if="index < 6">
                    ...
                    <router-link :to="{ name: 'forum', params: { id: ho.id, name:respace(ho.topic) }}"><h4>
                        {{ho.topic}}</h4></router-link>
            ...
            <div id="advert-side" class="panel panel-default ">
                ...
                <div>
                    ...
                    <a v-if="side_ad[1]" :href="side_ad[1].url">
                        <adimage :src="'/'+side_ad[1].image_url" width="100%" height="100%"
                                 style="padding: 1em;"></adimage>
                    </a>
                    <a v-if="side_ad[2]" :href="side_ad[2].url">
                        <adimage :src="'/'+side_ad[2].image_url" width="100%" height="100%"
                                 style="padding: 1em;"></adimage>
                    </a>
