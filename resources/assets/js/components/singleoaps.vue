    ...
    <div id="">
        ...
        <div class="doubleColumns">
            ...
            <div class="doubleColumn">
                ...
                <h5 style="text-align: center;"><span class="oaps"> {{oap.name}} </span></h5><br>
                <p v-html="oap.description">

                </p>
                <br><br>
                <p><span id="links" class="ion-social-twitter"> <span>@{{oap.twitter}} </span></span></p>
                <p><span id="links" class="ion-social-facebook"> <span> {{oap.facebook}} </span></span></p>
                <p><span id="links" class="ion-ios-email"> <span> {{oap.email}} </span></span></p>
                <p><span id="links" class="ion-social-whatsapp-outline"> <span> +{{oap.phone}} </span></span></p>
            </div>
        </div>
