     ...
     <clip-loader v-if="loading" color="blue"></clip-loader>
        ...
        <div class="row product" style="background-image:url('https://www.dropbox.com/cms/content/dam/dropbox/www/en-us/help/170222_CX_HelpCenter_Production_Header.svg');background-repeat:no-repeat;background-position:bottom;">
            <div class="col-md-7 col-md-offset-3" style="margin-bottom:2em;">
                ...
                <textarea style="width:100%;height:100px;margin-bottom:0;margin-top:2em;outline:none;font-size: 1.3em;padding-left:2em;padding-top:1em;font-family: 'Circular-Book';color: #000;border-radius:51px;"></textarea>
                <h6 style="text-align:center;margin-top:0;"></h6>
                <h6 style="margin-top:0;margin-bottom:15em;width:100%;">Choose a category <select class="js-example-placeholder-single">
  <option value="AL">Alabama</option>
  <option value="WY">Wyoming</option>
</select>
<button class="btn btn-primary" type="button" data-toggle="modal" data-target="#modal1" style="float:right;background-color:rgb(7,17,254);border:none;border-radius: 50px;width: 144px;height: 43px;">Publish </button></h6></div>
        </div>
    </div>
