<template>
    <div id="forumcomponent">
      ...
      <option value="WY">Wyoming</option>
                            ...
                            <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#modal1" style="float:right;background-color:rgb(7,17,254);border:none;border-radius: 50px;width: 144px;height: 43px;">Publish </button></h6>
                    </div>
                </div>
            </div>
