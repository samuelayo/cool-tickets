                    ...
                    <div class="col-md-6">
                        <div class="row"><br><br>
                            <div class="col-sm-3" v-for="pod in part_one">
                                <a href="" class="ratio img-responsive img-circle"
                                   :style="'background-image: url('+pod.image+'); box-shadow: inset 0 0 0 1000px rgba(0,0,0,.2);'"></a>
                                <span class="badge badge-play"><small><span
                                        class="ion-ios-play"></span></small>  </span>
