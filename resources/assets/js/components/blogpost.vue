                ...
                <div class="col-md-9">
                    <div class="panel panel-default shadowed">
                        ...
                        <div class="item-content ">
                            <div class="item-meta">
                                <div class="author"
                                     :style="'background: url('+post.user.image+'); background-size: cover; '">
                                </div>
                                ...
                                <div class="title-meta">
                                    <h5>
                                        <router-link
                                                :to="{ name: 'blogcategory', params: { id:post.category.id, name:post.category.name }}">
                                            {{post.category.name}}
                                        </router-link>
                                    </h5>
                                    <br>
                            ...
                            <center>
                                <ul class="social-network social-circle">
                                    ...
                                    <li>
                                        <a style="border: 1px solid #3B5998; color: #3B5998 !important; background: #3B5998;"
                                           href="#" class="icoFacebook" title="Facebook" onclick="sharon.facebook()"><i
                                                class="fa fa-facebook"></i></a></li>
                                    <li>
                                        <a style="border: 1px solid #33ccff; color: #33ccff !important; background: #33ccff;"
                                           href="#" class="icoTwitter" title="Twitter" @click="twitter()"><i
                                                class="fa fa-twitter"></i></a></li>
                                    <li>
                                        <a style="border: 1px solid #BD3518; color: #BD3518 !important; background: #BD3518;"
                                           href="#" class="icoGoogle" title="Google +" onclick="sharon.plus()"><i
                            ...
                            <div class="panel"
                                 style="width:60%; background:none; margin:0 auto; border: none !important;">
                                    ...
                                    <div v-if="shows.length != 0">
                                        ...
                                        <div style="background: #333;"><br>
                                            ...
                                            <p style="margin-left: 3em;">
                                                <iframe width="95%" height="600"
                                                        :src="'https://www.youtube.com/embed/'+gup('v', shows[0].link)"
                                                        frameborder="0" allowfullscreen></iframe>
                                            </p>
                                            <h1 class="video-title">{{shows[0].title}}</h1>
                                            <p class="video-meta">{{shows[0].user.name}} /
                                                {{timeago(shows[0].created_at)}}</p>
                                            ...
                                            <flickity ref="flickity" :options="flickityOptions">
                                                <div class="carousel-cell" v-for="(sho, index) in shows"
                                                     v-if="index !=0" @click="showme(sho)">
                                                    <p><span class="catgory">{{sho.title}}</span> <br>{{sho.description}}
                                                    </p>
                                                </div>
                                            </flickity>
