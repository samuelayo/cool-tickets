...
class ForumcategoryCrudController extends CrudController
{
    ...
    public function setUp()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Forumcategory');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/forumcategory');
        $this->crud->setEntityNameStrings('forumcategory', 'forumcategories');
